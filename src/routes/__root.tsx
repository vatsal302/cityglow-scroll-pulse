...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Conduct the city's light" },
      { property: "og:description", content: "An interactive 3D city simulation. Scroll through time. Move to conduct light. Click to cut the power." },
